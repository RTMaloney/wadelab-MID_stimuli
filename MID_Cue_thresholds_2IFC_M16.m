function MID_Cue_thresholds_2IFC_M16 (SubjCode, Cue, CohOrCont, frequency, amplitude, runN)
...
% Timing:
TrialDuration = 1; % duration of the stimulus, IN SEC
...
try % Start a try/catch statement, in case something goes awry with the PTB functions
    ...
    [parameters, DotsIdxL, DotsIdxR, dstRectsL, dstRectsR, FramesFullCycle] = SetUpDotPositions ...
        (Cue, -1, C, Trial, CohOrCont, amplitude, frequency, AdjustXBy, PPD, Dots, texrect, imsize, parameters);
    ...
    for Trial = 1:num_stim  % loop across trials
        ...
        for Interval = 1:2            % Loop across the 2 intervals.
            ...
            tic
            [parameters, DotsIdxL, DotsIdxR, dstRectsL, dstRectsR, FramesFullCycle] = SetUpDotPositions ...
                (Cue, trial_order(Trial, Interval), C, Trial, CohOrCont, amplitude, frequency, AdjustXBy, PPD, Dots, texrect, imsize, parameters);
            toc
...
function [parameters, DotsIdxL, DotsIdxR, dstRectsL, dstRectsR, FramesFullCycle] = SetUpDotPositions ...
    (Cue, trial_order, C, Trial, CohOrCont, amplitude, frequency, AdjustXBy, PPD, Dots, texrect, imsize, parameters)
disp(trial_order)
